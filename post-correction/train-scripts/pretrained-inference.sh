...
do
    ...
    /home/ocr_proj/.conda/envs/ByT5/bin/python /home/ocr_proj/OCR/post_correction/pe-ocr-sanskrit/train-scripts/pretrained-inference-byt5-sanskrit.py --experiment $EXPERIMENT --fold $FOLD
